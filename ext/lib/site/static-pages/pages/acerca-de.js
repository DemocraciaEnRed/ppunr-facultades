              ...
              <div className="fila faq text-left">
                ...
                <Accordion>
                  <div data-trigger="+ ¿Quiénes pueden participar del PP Facultades?">
                    <p className='p-padding'>Pueden participar docentes, nodocentes, estudiantes, graduados y graduadas de las 12 Facultades y las Sedes de la UNR.</p>
                  </div>
                  ...
                  <div data-trigger="+ ¿Qué tipo de ideas esperamos que subas al Foro del PP Facultades?">
                    ...
                    <p>En el caso del PP Escuelas, las personas que integran el Politécnico, el Superior y la Agrotécnica propondrán ideas que impacten sobre su propia comunidad educativa.</p>
                  </div>
                  ...
                  <div data-trigger="+ ¿Qué espacios podemos intervenir con proyectos del PP?">
                    <p className='p-padding'>Los proyectos deben ser desarrollados por integrantes de por lo menos dos claustros. Tiene que incluir resultados para más de una unidad académica o bien para algún espacio común de la Universidad (comedores, gimnasios, Sede, Rectorado, CUR, anexo, etc)</p>
                  </div>

                  <div data-trigger="+ ¿Cuál es el monto asignado al PPUNR edición 2020?">
                    <p className='p-padding'>Dieciocho millones de pesos, de los cuáles, cada Escuela tendrá disponible un millón para discutir en el marco de su comunidad, y el resto, quince millones, estará destinado al PP Facultades.</p>
                  </div>

                  <div data-trigger="+ ¿Cómo elegiremos los proyectos a ejecutarse en 2021?">
                    <p className='p-padding'>Se realizarán jornadas de votación en el mes de octubre/noviembre, previa difusión de los proyectos elegibles, para que toda la comunidad de la UNR puede decidir cuáles serán ejecutarán hasta alcanzar el total de la partida presupuestaria afectada al PP Facultades. Es decir que, de acuerdo al monto de los proyectos elegidos, podrán ejecutarse uno o más proyectos. </p>
                  </div>

                  <div data-trigger="+ ¿Pueden participar los/las estudiantes de posgrado?">
                    <p className='p-padding'>Sí, pueden participar todos/as los/las estudiantes de posgrado. </p>
                  </div>

                  <div data-trigger="+ ¿Pueden participar los/las estudiantes y docentes de ProUaPam (Programa para Adultos Mayores)?">
                    <p className='p-padding'>Sí, pueden participar todos/as los/las integrantes del PRoUaPam.</p>
                  </div>

                  <div data-trigger="+ ¿ Pueden participar los/las integrantes de  las Extensiones áulicas?">
                    <p className='p-padding'>Sí, pueden participar todos/as los/las integrantes de las extensiones áulicas.</p>
                  </div>
