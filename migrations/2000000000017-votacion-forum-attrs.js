...
const newFields = [
	...
	},
	{
		"name" : "escuela",
		"title" : "Escuela",
		"description" : "La escuela a la cual pertenece el proyecto",
		"kind" : "Enum",
		"mandatory" : true,
		"groupOrder" : 0,
		"group" : "",
...
exports.up = function up (done) {
  dbReady()
    ...
    .then((escuelas) => {
			...
			const campoEscuela = newFields.find(c => c.name == 'escuela')
			escuelas.forEach(e => campoEscuela.options.push({name: e._id, title: e.abreviacion}))
