...
{ 'order': 2, 'question': '+ ¿Cómo participo?', 'answer': '<p className="p-padding">Te invitamos a <a href="/signup" className="text-primary">registrarte aquí</a> para votar. Además, habrá postas presenciales de votación paralelamente al proceso virtual. Podés ver el calendario haciendo <a href="/s/agenda" className="text-primary">clic acá</a>.</p>' },
