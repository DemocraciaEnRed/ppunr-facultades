        ...
        }
        {
          ...
          (
            <div id='signup-message'>
              ...
              {/* desactivamos validación por mail
              ...
              <p className='lead'>Ya estás registrado/a.</p>
              <p className='lead'>Ahora podés participar como proyectista en alguna de las ideas que te interese aportar.</p>
              <p className='lead'><Link to='/signin'>Iniciá sesión</Link> con tu nuevo usuario, entrá en el foro de tu escuela y hacé click en "¡Quiero ser proyectista!".</p>
            </div>
          )
        }
      </div>
