...
const EscuelaSchema = new Schema({
  ...
  urlCorta: { type: String, required: true, minlength: 1, maxlength: 50 },
  mailPadron: { type: String, required: true, minlength: 1, maxlength: 50 },
  tituloForo: { type: String, required: true, minlength: 1, maxlength: 50 }
}, { id: false })
