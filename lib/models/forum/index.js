...
ForumSchema.methods.setConfigs = function (body, cb) {
  let booleans = [
    'propuestasAbiertas',
    'mostrarSeccionEventos',
    'mostrarFormulariosProyectistas',
    'ideacion',
    'preVotacion',
    'votacion',
    'seguimientoNormal',
    'mostrarInfoEncuentros',
    'mostrarLinkVotaciones'
  ]
  let config = body || {}
  booleans.forEach((b) => {
    config[b] = config[b] === 'on'
  })
  this.set('config', body)
  this.save(cb)
}
