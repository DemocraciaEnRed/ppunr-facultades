...
app.use(require('lib/api/text'))

app.use(require('lib/api/facultad'))

app.use(require('lib/api/claustro'))

app.use(require('lib/api/eje'))

app.use(require('lib/api/padron'))

app.use(require('lib/api/proyectistas'))

app.use(require('lib/api/oficiales'))

app.use(require('lib/api/agenda'))

app.use(require('lib/api/stats'))
