    ...
    if (padron){
      ...
      api.escuela.get(profile.escuela).then(escuela => {
        ...
        return res.status(200).json({
          error: `Tu DNI no se encuentra en el padrón. Primero revisá si tu DNI es el correcto o enviá un correo a presupuestoparticipativo@unr.edu.ar informando el problema.`
        })
      })
  })
})
