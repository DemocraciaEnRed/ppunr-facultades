...
app.post('/signup', function (req, res) {
  ...
  api.padron.isInPadron(profile.dni).then(padron => {
    if (padron){
      ...
      return res.status(200).json({ error: 'Tu DNI no se encuentra en el padrón. Revisá si tu DNI es el correcto o escribinos a presupuestoparticipativo@unr.edu.ar completando los siguientes datos: DNI, claustro, Facultad y Carrera.' })
  })
})
