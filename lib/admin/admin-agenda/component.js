...
export default class AdminAgenda extends Component {
  ...
  render () {
    ...
    let { agenda, isLoading, responseFail, responseSuccess, isSending } = this.state
    return (
      <div>
        <h2>Agenda</h2>
        {/* <p className='h3'>Agregar nuevo evento</p> */}
        {
          ...
          <div className="alert alert-warning" role="alert">
            Por favor, utilice Google Chrome para utilizar el componente de Agregar nuevos eventos a la agenda.
          </div>
        }
            ...
            <div className='row'>
              ...
              <div className='col-md-3'>
                <div className='form-group'>
                  ...
                  <input type='time' id='selectHour' disabled={isSending} onChange={this.yearOnChange} className='form-control' name='year' />
                </div>
              </div>
            </div>
            <div className='form-group'>
              ...
              return (
                <tr key={index}>
                  ...
                  <td>
                    ...
                    <span><small>{evento.descripcion}</small></span>
                  </td>
