        ...
        <table className='table table-bordered'>
          <tbody>
            ...
            <tr>
              ...
              { isLoadingVotacion ? <td className="text-center">Cargando...</td> :
               <td className="text-center">{usersWhoDidntVotedCount > 0 ? (dniCount - ((users - userNotEmailValidated) - usersWhoDidntVotedCount)) : 0}</td> }
            </tr>
            <tr>
              ...
              { isLoadingVotacion ? <td className="text-center">Cargando...</td> :
               <td className="text-center">{usersWhoDidntVotedCount > 0 ? ((users - userNotEmailValidated) - usersWhoDidntVotedCount) : 0}</td> }
            </tr>
            <tr>
