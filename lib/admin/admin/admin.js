...
import AdminOficiales from '../admin-oficiales/component'
...
page(urlBuilder.for('admin.oficiales'), (ctx) => {
  ctx.sidebar.set('oficiales')
  render(<AdminOficiales forum={ctx.forum} />, document.querySelector('.admin-content'))
})
