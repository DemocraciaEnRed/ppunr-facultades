...
app.get(urlBuilder.for('admin.contenido-portada'), require('lib/admin/layout'))
app.get(urlBuilder.for('admin.proyectistas'), require('lib/admin/layout'))
app.get(urlBuilder.for('admin.oficiales'), require('lib/admin/layout'))
app.get(urlBuilder.for('admin.agenda'), require('lib/admin/layout'))
app.get(urlBuilder.for('admin.padron'), require('lib/admin/layout'))
app.get(urlBuilder.for('admin.stats'), require('lib/admin/layout'))
app.get(urlBuilder.for('admin.about-us'), require('lib/admin/layout'))
app.get(urlBuilder.for('admin.settings-stage'), require('lib/admin/layout'))
