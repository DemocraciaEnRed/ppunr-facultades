  ...
  dosomething() {
    ...
    request
      ...
      .end((err, res) => {
        ...
        else this.find('pre#response-dni')[0].innerHTML = this.formatResponse(res.body)
...
${data.user.facultad}
      ...
      return 'El usuario esta en el padron pero no esta reguistrado en la plataforma'
    }
  }
